// raw-http-client: allowed — дубль заголовка (#73) и не-ASCII значение (#75)
// через fetch и через обвязку не отправить: fetch склеивает повторы сам,
// а символ выше 255 не пропускает вовсе. Цена объявления: ответы этого файла
// не проходят автоматических сверок обвязки, поэтому проверяются здесь руками.
/**
