...
describe('@req F2 · повтор с тем же ключом и тем же телом', () => {
...
describe('@req F3 · тот же ключ с другим телом', () => {
...
describe('@req F4 · гонка — главный дефект темы', () => {
...
describe('@req F6 · ключ уникален в пределах мерчанта', () => {
