...
def _main():
    ...
    regression_pairs = [
        ...
        ("проза с $HOME в кавычках у незнакомой команды",
         'mytool --eval "пути считаются от $HOME" > docs/x.md',
         "удаление домашнего каталога оттуда же — отказ",
         'mytool --eval "rm -rf $HOME/probe"'),
